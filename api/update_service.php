<?php
// =============================================
//  API : update_service.php – Modifier un service
// =============================================
...
if (empty($id) || empty($nom) || empty($prix)) {
    echo json_encode(['success' => false, 'message' => 'ID, nom et prix sont obligatoires.']);
    exit;
}
...
// Modifier le service
$result = $serviceClass->update($id, $nom, $categorie, (float)$prix, $description, $image);
